...
| <a name="input_common_name"></a> [common\_name](#input\_common\_name) | The parent domain suffix for the certificate | `string` | `null` | no |
...
| <a name="input_container_memory"></a> [container\_memory](#input\_container\_memory) | The container memory | `number` | `512` | no |
| <a name="input_container_port"></a> [container\_port](#input\_container\_port) | The container port | `number` | `80` | no |
| <a name="input_container_registry"></a> [container\_registry](#input\_container\_registry) | The registry and container name | `string` | `null` | no |
...
| <a name="input_ecr_kms_key_arn"></a> [ecr\_kms\_key\_arn](#input\_ecr\_kms\_key\_arn) | KMS Key ARN for ECR | `string` | `"arn:aws:kms:::alias/aws/ecr"` | no |
| <a name="input_ecr_resource_constraints"></a> [ecr\_resource\_constraints](#input\_ecr\_resource\_constraints) | Constraints for Token Access to ECR | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
...
| <a name="input_host_port"></a> [host\_port](#input\_host\_port) | The host port | `number` | `80` | no |
| <a name="input_id_length_limit"></a> [id\_length\_limit](#input\_id\_length\_limit) | Limit `id` to this many characters (minimum 6).<br>Set to `0` for unlimited length.<br>Set to `null` for keep the existing setting, which defaults to `0`.<br>Does not affect `id_full`. | `number` | `null` | no |
| <a name="input_internal"></a> [internal](#input\_internal) | Type of ALB | `bool` | `true` | no |
...
| <a name="input_non_routable_security_group_ids"></a> [non\_routable\_security\_group\_ids](#input\_non\_routable\_security\_group\_ids) | The private security for ECS deployments | `list(string)` | `[]` | no |
| <a name="input_non_routable_subnet_ids"></a> [non\_routable\_subnet\_ids](#input\_non\_routable\_subnet\_ids) | The non routable subnets for ECS deployments | `list(string)` | `[]` | no |
...
| <a name="input_routable_security_group_ids"></a> [routable\_security\_group\_ids](#input\_routable\_security\_group\_ids) | The public security for ECS deployments | `list(string)` | `[]` | no |
| <a name="input_routable_subnet_ids"></a> [routable\_subnet\_ids](#input\_routable\_subnet\_ids) | routable\_subnet\_ids | `list(string)` | `[]` | no |
| <a name="input_s3_resource_constraints"></a> [s3\_resource\_constraints](#input\_s3\_resource\_constraints) | Constraints for S3 access from ECR | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
| <a name="input_secretsmanager_kms_key_arn"></a> [secretsmanager\_kms\_key\_arn](#input\_secretsmanager\_kms\_key\_arn) | KMS Key ARN for Secrets Manager | `string` | `"arn:aws:kms:::alias/aws/secretsmanager"` | no |
| <a name="input_secretsmanager_resource_constraints"></a> [secretsmanager\_resource\_constraints](#input\_secretsmanager\_resource\_constraints) | Constraints for Secrets Manager access from ECR | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
...
| <a name="input_sqs_resource_constraints"></a> [sqs\_resource\_constraints](#input\_sqs\_resource\_constraints) | Constraints for SQS access from ECR | `list(string)` | <pre>[<br>  "*"<br>]</pre> | no |
...
| <a name="input_zone_id"></a> [zone\_id](#input\_zone\_id) | The domain zone id | `string` | `null` | no |
